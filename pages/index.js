        ...
        <div className=" hidden sm:block">
          <div className="container_pc">
              ...
              <div className="subpage_1">
                  ...
                  <div className="subpage_1_title_wrapper">
                      <p className="subpage_1_title text-[#000000]">INFERER</p>
                  </div>
              ...
              <div className="subpage_2">
                  ...
                  <img src="/icon_logo_yun.png" style={{marginTop: '26px', width: '51.82%', height: '50%', "WebkitUserDrag": "none"}}/>
                  ...
                  <img src="/img_1.png" style={{marginTop: '41px', marginBottom: '112px', width: '46.20%', height: '50%', "WebkitUserDrag": "none"}} />
              </div>
              ...
              <div className="subpage_3">
                  ...
                  <img src="/built.png" style={{marginTop: '26px', width: '46.35%', height: '50%', "WebkitUserDrag": "none"}}/>
                  ...
                  <img src="/img_3.png" className='img-w-100' style={{marginTop: '54px', marginBottom: '112px', width: '46.20%', height: '45%', "WebkitUserDrag": "none"}}/>
              </div>

              {/*page 4*/}
              <div className="subpage_4">
                  <LogoText text="Products" customStyle={{marginTop: '5.35%'}}></LogoText>
                  <img src="/inferer_search.png" style={{marginTop: '1.68%', width: '65.68%', height: '33.27%', "WebkitUserDrag": "none"}}/>
                  <img src="/inferer_api.png" style={{marginTop: '26px', marginBottom: '100px', width: '65.68%', height: '33.27%', "WebkitUserDrag": "none"}}/>
              </div>
              ...
              <div className="subpage_5">
                  ...
                  <img src="/img_4.png" style={{marginTop: '54px', marginBottom: '112px', width: '46.20%', height: '0%', "WebkitUserDrag": "none"}}/>
              </div>
