...
const SubPage1 = () => {
  return (
    <div className="bg-[url('https://website-1315068501.cos.ap-nanjing.myqcloud.com/web_inferer/pc/subpage1_bg.png')] flex justify-center bg-no-repeat" style={{backgroundSize: '100% auto', backgroundColor: '#0f0923'}}>
