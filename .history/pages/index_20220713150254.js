        ...
        <div className="container">
            ...
            <div className="subpage_4">
                ...
                <div style={{ position:'relative'}}>
                  <img src="/inferer_search1.png" style={{marginTop: '26px', width: '70%', marginLeft: '50px',height: '70%',position:'relative'}}/>
                     
                  <img src="/inferer_api1.png" style={{marginTop: '26px', marginBottom: '100px', marginLeft: '50px', width: '70%', height: '70%'}}/>
              </div>
            </div>
