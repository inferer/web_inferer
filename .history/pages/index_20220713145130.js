    ...
    return (
        <div className="container">
            ...
            <div className="subpage_4">
                ...
                <div className='top1' style={{ position:'relative',marginTop: '26px', marginBottom: '100px', marginLeft: '50px', width: '70%', height: '70%'}}>
                   <img src="/inferer_search1.png"  style={{ marginLeft: '100px'}}/>
                  <img src="/img_card_left.png" style={{ width: '229px', height: '152px',position:'absolute',top:'-61px',left:'-68px'}}/>
                </div>
                <div className='top2' style={{ position:'relative',marginTop: '26px', marginBottom: '100px', marginLeft: '50px', width: '70%', height: '70%'}}>
                <img src="/inferer_api.png" style={{ marginLeft: '100px'}}/>
