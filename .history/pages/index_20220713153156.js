    ...
    return (
        <div className="container">
            ...
            <div className="subpage_4">
                ...
                <img src="/inferer_search11.png" style={{marginTop: '26px', width: '70%', marginLeft: '50px',height: '70%'}}/>
                <img src="/inferer_search22.png" style={{marginTop: '26px', marginBottom: '100px', marginLeft: '50px', width: '70%', height: '70%'}}/>
