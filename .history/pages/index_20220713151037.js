    ...
    return (
        <div className="container">
            ...
            <div className="subpage_4">
                ...
                {/* <div className='top1' style={{ position:'relative',marginTop: '26px', marginBottom: '100px', marginLeft: '50px' }}>
                   <img src="/inferer_search1.png"  style={{ marginLeft: '100px',width: '70%', height: '70%'}}/>
                  <img src="/img_card_left.png" style={{ width: '229px', height: '152px',position:'absolute',top:'-61px',left:'-68px'}}/>
                </div>
                <div className='top2' style={{ position:'relative',marginTop: '26px', marginBottom: '100px', marginLeft: '50px'}}>
                <img src="/inferer_api.png" style={{ marginLeft: '100px',width: '70%', height: '70%'}}/>
                <img src="/img_card_right2.png" style={{ width: '229px', height: '152px',position:'absolute',top:'-40px',right:'40px'}}/>
                </div> */}
                <div style={{ marginTop: '26px', width: '70%', marginLeft: '100px'}}>
                  <div style={{position:'relative'}}>
                       <img src="/inferer_search1.png" style={{height: '70%',marginLeft: '50px'}}/>
                       <img src="/img_card_left.png" style={{ width: '229px', height: '152px',position:'absolute',top:'38px',left:'-19px'}}/>
                    </div>
                    <div style={{position:'relative'}}>
                       <img src="/inferer_api.png" style={{height: '70%',marginLeft: '50px'}}/>
                       <img src="/img_card_right2.png" style={{ width: '229px', height: '152px',position:'absolute',top:'40px',right:'100px'}}/>
              </div>
              </div>
            </div>
