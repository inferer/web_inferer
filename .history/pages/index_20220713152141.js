            ...
            <div className="subpage_4">
                ...
                <div style={{ marginTop: '26px', width: '70%', marginLeft: '100px'}}>
                  <div style={{position:'relative'}}>
                       ...
                       <img src="/img_card_left.png" style={{position:'absolute',top:'26px',left:'-25px'}}/>
                    </div>
                    <div style={{position:'relative'}}>
                       <img src="/inferer_api.png" style={{width: '70%',height: '70%',marginLeft: '50px'}}/>
                       <img src="/img_card_right2.png" style={{ position:'absolute',top:'5px',right:'33px'}}/>
                 </div>
              </div>
            </div>
