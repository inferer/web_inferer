            ...
            <div className="subpage_4">
                ...
                <div style={{ marginTop: '26px', width: '70%', marginLeft: '100px'}}>
                  <div style={{position:'relative'}}>
                       ...
                       <img src="/img_card_left.png" style={{ height: '70%',position:'absolute',top:'38px',left:'-19px'}}/>
                    </div>
                    <div style={{position:'relative'}}>
                       <img src="/inferer_api.png" style={{height: '70%',marginLeft: '50px'}}/>
                       <img src="/img_card_right2.png" style={{ height: '90%',position:'absolute',top:'40px',right:'100px'}}/>
                 </div>
            </div>
            </div>
