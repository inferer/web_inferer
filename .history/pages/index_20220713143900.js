    ...
    return (
        <div className="container">
            ...
            <div className="subpage_4">
                ...
                <div className='top1' style={{marginTop: '26px', marginBottom: '100px', marginLeft: '50px', width: '70%', height: '70%'}}>
                <img src="/inferer_search1.png"/>
                  
                </div>
                <div className='top2' style={{marginTop: '26px', marginBottom: '100px', marginLeft: '50px', width: '70%', height: '70%'}}>
